...
{
    /// <inheritdoc cref="IVisualUserController" />
    // TODO: Add authentication
    // [FulcrumAuthorize(AuthenticationRoleEnum.InternalSystemUser)]
    [RoutePrefix("api/Users")]
    public class VisualUserController : ApiController, IVisualUserController
    {
        ...
        public VisualUserController(ICrud<User, string> persistance)
        {
